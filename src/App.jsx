...
const delivery = {
  Deliveroo: 'https://deliveroo.co.uk/menu/london/surrey-quays/welcome-inn-fish-bar-ltd',
...
function App() {
  ...
  return <div className="site-shell">
    <header className="site-header">
      ...
      <nav id="main-nav" className={menuOpen ? 'main-nav is-open' : 'main-nav'} aria-label="Main navigation"><a href="#menu">Menu</a><a href="#story">Our story</a><a href="#visit">Find us</a><a className="header-order" href={delivery.Deliveroo} target="_blank" rel="noreferrer">Order online +</a></nav>
    </header>
    <main id="top">
